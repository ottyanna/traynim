...
To get a more detailed description of the source code, refer to the [documentation](https://ottyanna.github.io/traynim/htmldocs/theindex.html).
...
The only thing you have to bear in mind is that the images must be named img0, img1, img2 etc (`inPfmFileName` is img in this case). This [script](scripts/stackMain.sh) makes this procedure automatic using [parallel](https://en.wikipedia.org/wiki/GNU_parallel).
